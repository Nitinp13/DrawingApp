...
//import kotlinx.synthetic.main.dialog_brush_size.*
...
class MainActivity : AppCompatActivity() {
                ...
                permission.entries.forEach {
                    ...
                    if (isGranted) {
                        ...
                        if (permissionName == Manifest.permission.READ_EXTERNAL_STORAGE) {
                            Toast.makeText(this, "Permission Declined for storage", Toast.LENGTH_LONG).show()
                        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var ibGallery : ImageButton = findViewById(R.id.ib_gallery)
        ibGallery.setOnClickListener(View.OnClickListener {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M &&
                    shouldShowRequestPermissionRationale(Manifest.permission.READ_EXTERNAL_STORAGE)){
                    showRationaleDialog("Permission for storage", "Permission for storage declined")
            }else{
